...
2.  [Filter accident dataset by main cause of accidents]{.underline} As there can be many causes of traffic accidents, we shall zoom in on a single main cause for this exercise in order to better analyse the effects of temporal factors.
